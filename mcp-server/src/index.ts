...
import { createSketch, CreateSketchInput } from "./tools/create-sketch.js";
import { addElement, AddElementInput } from "./tools/add-element.js";
import { createFloorPlan, CreateFloorPlanInput } from "./tools/create-floor-plan.js";
import { listElementTypes } from "./tools/list-elements.js";
import { exportSketch, ExportInput, listSketches } from "./tools/export.js";
    ...
    tools: [
      {
        ...
        description:
          "Create a hand-drawn style sketch from element definitions. " +
        ...
        inputSchema: {
          ...
          properties: {
            ...
            elements: {
              type: "array",
              description:
                "Array of sketch elements. Use skissify_list_element_types to see all available types and their properties.",
              items: {
                type: "object",
                properties: {
                  type: {
      ...
      },
      {
        ...
        description:
          "Add a single element to an existing sketch. " +
        ...
        inputSchema: {
          ...
          properties: {
            ...
            element: {
              type: "object",
              description:
                "The element to add. Use skissify_list_element_types to see all available types.",
              properties: {
                type: {
                  type: "string",
                  enum: ALL_ELEMENT_TYPES,
      ...
      },
      {
        ...
        description:
          "Create a floor plan sketch from room descriptions. " +
        ...
        inputSchema: {
          ...
          properties: {
            ...
            style: {
              ...
              description:
                "Visual style preset. napkin = warm/sketchy, blueprint = blue technical, clean = minimal. Default: napkin",
            },
            scale: {
              type: "string",
      ...
      },
      {
        ...
        description:
          "Returns all available sketch element types with their properties and examples. " +
      ...
      },
      {
        ...
        description:
          "Export a sketch as JSON (for pasting into Skissify editor) or as a Skissify URL. " +
      ...
      },
      {
        ...
        description:
          "Render a sketch directly to SVG by calling the Skissify API at http://localhost:3000/api/render. " +
      ...
      },
      {
        ...
        description:
          "List all sketches created in the current MCP server session. " +
  ...
  try {
    switch (name) {
      case "skissify_create_sketch": {
        const input = args as unknown as CreateSketchInput;
              ...
              text: JSON.stringify(
                {
                  ...
                  message:
                    "Sketch created. Use skissify_export to get the JSON for pasting into Skissify's editor, or skissify_add_element to add more elements.",
      ...
      case "skissify_add_element": {
        const input = args as unknown as AddElementInput;
      ...
      case "skissify_create_floor_plan": {
        const input = args as unknown as CreateFloorPlanInput;
              ...
              text: JSON.stringify(
                {
                  ...
                  message:
                    "Floor plan created. Use skissify_export to get the JSON, or skissify_add_element to add furniture, notes, etc.",
                  sketchData: result.data,
                },
                null,
                2
              ...
              text: JSON.stringify(
                {
                  ...
                  message:
                    "These are all available element types. Each has a 'type' field and type-specific properties. " +
      ...
      case "skissify_export": {
        const input = args as unknown as ExportInput;
      ...
      case "skissify_render": {
        const { sketchId, sketchData, baseUrl = "http://localhost:3000" } = args as {
          sketchId?: string;
          sketchData?: unknown;
          baseUrl?: string;
        };
        ...
        if (sketchId) {
          ...
          if (!stored) throw new Error(`Sketch not found: ${sketchId}`);
