          ...
          <div className="bg-[#fdf6e3] border border-[#93a1a1] rounded-2xl p-6 max-w-md w-full mx-4 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-1">
              {[
                ...
                { keys: ["Ctrl", "G"], desc: "Group selected elements (2+)" },
                { keys: ["Ctrl", "Shift", "G"], desc: "Ungroup selected elements" },
                { keys: ["Ctrl", "K"], desc: "Open command palette" },
                { keys: ["Ctrl", "Alt", "C"], desc: "Copy style (format painter)" },
                { keys: ["Ctrl", "Alt", "V"], desc: "Paste style onto selection" },
                ...
                { keys: ["F"], desc: "Fit view to selection (or fit all)" },
